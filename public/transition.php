...
<html>
<head>
    <title>Demo 1 - Sat Image Slider</title>
    <link href="themes/1/js-image-slider.css" rel="stylesheet" type="text/css" />
    <script src="themes/1/js-image-slider.js" type="text/javascript"></script>
    <link href="generic.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <div class="div1"><h2>Demo 1 - Sat Image Slider</h2>
    ...
    <div id="sliderFrame">
        <div id="ribbon"></div>
        <div id="slider">
            <a href="http://www.Sat.com/jquery-slider" target="_blank">
                <img src="images/image-slider-1.jpg" alt="Welcome to Sat.com" />
            </a>
    ...
    <div class="div2">
        <ul>
            ...
            Visit <a href="http://www.Sat.com/slider/javascript-image-slider-demo1" target="_blank">Online Demo 1</a> to see how each effect looks and how to customize</li>
